...
mainString<-paste0("Completion times and blocks (512 byte pages), benchmark ", i)
pngName<-paste0("BC512", i, ".eps")

faults<-ggplot(subset(Big512, bb==i), aes(x=Blocks, y=Count, color=factor(Method), shape=factor(Method))) + geom_point()  +
